...
const Card = () => {
  return (
    <div className="bg-gray-100 text-[#003366] p-6 md:p-10 md:h-[100vh] my-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-10 md:px-20 ">
        <div className="bg-white text-[#003366] p-6 rounded-lg flex flex-col items-center justify-between shadow-lg transition-transform transform hover:scale-105">
          <img src="icon1.webp" alt="" className="mb-4" />
        ...
        <div className="bg-white text-[#003366] p-6 rounded-lg flex flex-col items-center justify-between shadow-lg transition-transform transform hover:scale-105">
          <img src="icon2.webp" alt="" className="mb-4" />
        ...
        <div className="bg-white text-[#003366] p-6 rounded-lg flex flex-col items-center justify-between shadow-lg transition-transform transform hover:scale-105">
          <img src="icon3.webp" alt="" className="mb-4" />
        ...
        <div className="bg-white text-[#003366] p-6 rounded-lg flex flex-col items-center justify-between shadow-lg transition-transform transform hover:scale-105">
          <img src="icon4.webp" alt="" className="mb-4" />
